...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template name="xsl_balance_sheet">
        ...
        <div class="dataLabel" style="clear:both">date latest returns</div>
            <div class="dataValue ">
                <xsl:value-of select="Identification/FilingDetails/LatestReturns/DD"/>&#xA0;<span class="toMonthName"><xsl:value-of select="Identification/FilingDetails/LatestReturns/MM"/></span>&#xA0;<xsl:value-of select="Identification/FilingDetails/LatestReturns/CCYY"/>
        </div>
    ...
    <div class="matrix" id="balance_sheet_f_details_matrix">
        ...
        <table cellspacing="0" cellpadding="0" id="balancesheettable">
            <tr>
        ...
        <tr>
            ...
            <xsl:for-each select="Financials/Accounts">
                <td class="canHideTableIfValue"><xsl:value-of select="Currency"/><xsl:if test="CurrencyMultiplier = 'T'">&#xA0;000</xsl:if></td>
            </xsl:for-each>
        </tr>
        <tr>
...
<tr>
    ...
    <xsl:for-each select="Financials/Accounts">
        ...
        <tr>
            <th><div class="inCellSubTitle" style="background-color:#CBE4FC"><b>issued capital:</b></div>
                <div class="inCellSubTitle" style="background-color:#D5E2EE">ordinary shares</div>
                <div class="inCellSubTitle" style="background-color:#D5E2EE">preference share</div>
                <div class="inCellSubTitle" style="background-color:#D5E2EE">other issued capital</div>
                <div class="inCellSubTitle" >Interest In Own Shares</div>
...
-->
        ...
        <tr>
            <th>
             ...
             <xsl:for-each select="Financials/Accounts">
                <td style="vertical-align:top;" class="num">
                    <span> <xsl:value-of select="BalanceSheet/SharePremium"/></span>
                </td>
            </xsl:for-each>
        </tr>
        ...
        <tr>
            <th>
             ...
             <xsl:for-each select="Financials/Accounts">
                <td style="vertical-align:top;" class="num">
                    <span> <xsl:value-of select="BalanceSheet/RevaluationReserve"/></span>
                </td>
            </xsl:for-each>
        </tr>
        ...
        <tr>
            <th>
             ...
             <xsl:for-each select="Financials/Accounts">
                <td style="vertical-align:top;" class="num">
                    <span> <xsl:value-of select="BalanceSheet/RetainedEarnings"/></span>
                </td>
            </xsl:for-each>
        </tr>
        ...
        <tr>
            <th>
             ...
             <xsl:for-each select="Financials/Accounts">
                <td style="vertical-align:top;" class="num">
                    <span> <xsl:value-of select="BalanceSheet/Other"/></span>
                </td>
            </xsl:for-each>
        </tr>
