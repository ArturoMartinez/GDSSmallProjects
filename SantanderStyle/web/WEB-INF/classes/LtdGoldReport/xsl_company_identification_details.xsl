        ...
        <div class="section" id="company_identification_details">
            ...
            <div class="dataValue" style="overflow:auto">
                <xsl:value-of select="Identification/TradingLocation/LocationLine1"/>&#xA0;
                    <xsl:if test="Identification/TradingLocation/LocationLine2!=''"><xsl:value-of select="Identification/TradingLocation/LocationLine2"/>&#xA0;</xsl:if>
                    <xsl:if test="Identification/TradingLocation/LocationLine3!=''"><xsl:value-of select="Identification/TradingLocation/LocationLine3"/>&#xA0;</xsl:if>
                    <xsl:if test="Identification/TradingLocation/LocationLine4!=''"><xsl:value-of select="Identification/TradingLocation/LocationLine4"/>&#xA0;</xsl:if>
                    <xsl:if test="Identification/TradingLocation/LocationLine5!=''"><xsl:value-of select="Identification/TradingLocation/LocationLine5"/>&#xA0;</xsl:if>
                    <xsl:if test="Identification/TradingLocation/Postcode!=''"><xsl:value-of select="Identification/TradingLocation/Postcode"/></xsl:if>
            </div>
            ...
            <div class="dataValue listing" style="overflow:auto;width:auto">
                <xsl:for-each select="Identification/SICInformation1980">
            ...
            <xsl:if test="Identification/PreviousAddresses/NumPrevAddresses[.>0]">
