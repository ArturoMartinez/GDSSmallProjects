...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    <xsl:template name="xsl_instalment_cais">
        <div class="section" id="insaltment_cais">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <xsl:for-each select="LtdCompanyCAISSummary/MonthlyData">
                        <tr>
                            <td>
                                <span>
                                    <xsl:value-of select="Month-Yyyy"/> / <xsl:value-of
                                        select="Month-Mm"/>
                                </span>
                            </td>
                            <td>
            ...
            <div class="dataValue">
                <xsl:value-of select="LtdCompanyCAISDetails/CaisLastUpdate/YYYY"/>/
                <xsl:value-of select="LtdCompanyCAISDetails/CaisLastUpdate/MM"/>/
                <xsl:value-of select="LtdCompanyCAISDetails/CaisLastUpdate/DD"/></div>
            <br/>
            <div class="dataLabel">default date</div>
            <div class="dataValue">
                <xsl:value-of select="LtdCompanyCAISDetails/DefaultDate/YYYY"/>/
                <xsl:value-of select="LtdCompanyCAISDetails/DefaultDate/MM"/>/
                <xsl:value-of select="LtdCompanyCAISDetails/DefaultDate/DD"/>
            </div>
            <br/>
