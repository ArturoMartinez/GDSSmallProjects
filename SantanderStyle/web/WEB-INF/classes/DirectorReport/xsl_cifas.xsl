            ...
            <xsl:for-each select="DetailDirectorCIFAS">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div class="dataValue">
                            <xsl:call-template name="commaSeparatedValue">
                                <xsl:with-param name="curValue" select="Address/*"></xsl:with-param>
                    ...
                    <li>
                        ...
                        <div class="dataValue">
                            <xsl:value-of select="Supplier/DateSuppliedDd"/>&#xA0;
                            <span class="toMonthName">
                                <xsl:value-of select="Supplier/DateSuppliedMm"/>
                            </span>&#xA0;
                            <xsl:value-of select="Supplier/DateSuppliedYyyy"/>
                        </div>
                    </li>
